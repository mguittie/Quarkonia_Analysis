...
// Int_t trkBin[] = {1, 8, 14, 20, 25, 33, 41, 50, 60, 80, 115}; //binning maximum ref
Int_t trkBin[] = {1, 9, 15, 21, 26, 34, 42, 51, 61, 81, 115}; //binning maximum ref
// Double_t trkBin[] = {1.0, 9.0, 14.0, 21.0, 33.0, 50.0, 51.0, 80.0}; //binning maximum ref
// Double_t trkBin[] = {1.0, 5.0, 6.0, 10.0, 11.0, 14.0, 15.0, 17.0, 18.0, 23.0, 24.0, 28.0, 29.0, 34.0, 35.0, 42.0, 43.0, 54.0, 55.0, 83.0}; //binning minimum ref
...
//  fhNtrk->GetAxis(0)->SetRangeUser(30, 40);
  ...
  const Int_t nBinZvtx = 4; // 10 bins of 2 cm
  ...
  fitAlpha[nBinZvtx]->SetLineColor(2);
